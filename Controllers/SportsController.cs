...
namespace SportUniTrack.Controllers
{
    public class SportsController : Controller
    {
        ...
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Rules,ImageUrl")] Sport sport)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Rules,ImageUrl")] Sport sport)
        {
            if (id != sport.Id)
            {
                return NotFound();
